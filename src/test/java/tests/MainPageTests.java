...
public class MainPageTests extends BaseTest {
    ...
    @Test
    @Story("TC-001-01 | Main page > Logo in the header")
    ...
    @Test
    @Story("TC-001-02 | Main page > link Главная in the header")
    ...
    @Test
    @Story("TC-001-03 | Main page > link Epolif Aqua in the header")
    ...
    @Test
    @Story("TC-001-04 | Main page > link Epolif GL7 in the header")
    ...
    @Test
    @Story("TC-001-05 | Main page > link Epolif GL21 in the header")
    ...
    @Test
    @Story("TC-001-06 | Main page > link Epolif ACP1 in the header")
    ...
    @Test
    @Story("TC-001-07 | Main page > footer > information about company")
    ...
    @Test
    @Story("TC-001-08 | Main page > footer > Up button")
    ...
    @Test
    @Story("TC-001-09 | Main page > Presence of the promo video")
